...
export function ExpenseTable({ data, categories }: { data: Expense[], categories: Category[] }) {
  ...
  const columns: ColumnDef<Expense>[] = [
    ...
    },
    {
      ...
      header: "Category",
      cell: ({ row }) => {
        const category = row.original.categories?.name || "Uncategorized"
    ...
    <div className="w-full">
      <div className="flex items-center py-4">
        ...
        <div className="ml-auto">
           {/* Add Expense Button is moved to parent for layout reasons, or can be here */}
        </div>
      </div>
